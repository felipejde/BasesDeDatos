...
ALTER TABLE Imparte ADD CONSTRAINT fk_imparte_id_empleado FOREIGN KEY (fk_id_empleado) REFERENCES Entrenador(pk_id_empleado)ON DELETE CASCADE;
ALTER TABLE Imparte ADD CONSTRAINT fk_imparte_id_instructor FOREIGN KEY (fk_id_instructor) REFERENCES Instructor(pk_id_instructor)ON DELETE CASCADE;
ALTER TABLE Imparte ADD CONSTRAINT fk_imparte_id_clase FOREIGN KEY (fk_id_clase) REFERENCES Clase(pk_id_clase)ON DELETE CASCADE;
